...
func UnpackHashWithSha256Input(input []byte) (string, error) {
	res, err := Sha256ABI.UnpackInput("", input)
	if err != nil {
		return "", err
	}
...
// PackHashWithSha256 packs [value] of type string into the appropriate arguments for .
// the packed bytes include selector (first 4 func signature bytes).
// This function is mostly used for tests.
func PackHashWithSha256(value string) ([]byte, error) {
	return Sha256ABI.Pack("", value)
}
...
func PackHashWithSha256Output(hash [32]byte) ([]byte, error) {
	return Sha256ABI.PackOutput("", hash)
}
